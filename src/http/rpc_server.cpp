...
rpc_server::rpc_server(bool use_testnet_rules, libbitcoin::blockchain::block_chain & chain, uint32_t rpc_port, const std::unordered_set<std::string> & rpc_allowed_ips)
